...
const u32 gTrainerFrontPic_Miku[] = INCBIN_U32("graphics/trainers/front_pics/miku.4bpp.lz");
const u16 gTrainerPalette_Miku[] = INCBIN_U16("graphics/trainers/front_pics/miku.gbapal");

const u8 gTrainerBackPic_Teto[] = INCBIN_U8("graphics/trainers/back_pics/miku.4bpp.lz");
const u16 gTrainerPalette_Teto[] = INCBIN_U16("graphics/trainers/front_pics/miku.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
    {
        ...
        TRAINER_SPRITE(TRAINER_PIC_MIKU, gTrainerFrontPic_Miku, gTrainerPalette_Miku),
        TRAINER_SPRITE(TRAINER_PIC_TETO, gTrainerFrontPic_Teto, gTrainerPalette_Teto),
};
